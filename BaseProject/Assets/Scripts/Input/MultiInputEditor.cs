...
public class MultiInputEditor : Editor {
	...
	void displayControllerInput(SerializedProperty state) {
		...
		if (state.FindPropertyRelative ("displayMainButtons").boolValue) {
			...
			labelWithProperty ("Xbox A", 140, selectedVars.GetArrayElementAtIndex (0), true, true, 2);

			labelWithProperty ("Xbox B", 140, selectedVars.GetArrayElementAtIndex (1), true, true, 2);

			labelWithProperty ("Xbox X", 140, selectedVars.GetArrayElementAtIndex (2), true, true, 2);

			labelWithProperty ("Xbox Y", 140, selectedVars.GetArrayElementAtIndex (3), true, true, 2);
		} else {
		...
		if (state.FindPropertyRelative ("displayMiscButtons").boolValue) {
			...
			labelWithProperty ("Xbox Right Stick", 140, selectedVars.GetArrayElementAtIndex (6), true, true, 2);

			labelWithProperty ("Xbox Right Shoulder", 140, selectedVars.GetArrayElementAtIndex (7), true, true, 2);

			labelWithProperty ("Xbox Left Stick", 140, selectedVars.GetArrayElementAtIndex (8), true, true, 2);

			labelWithProperty ("Xbox Left Shoulder", 140, selectedVars.GetArrayElementAtIndex (9), true, true, 2);
		...
		if (state.FindPropertyRelative ("displayDpadButtons").boolValue) {
			...
			labelWithProperty ("Xbox Dpad Up", 140, selectedVars.GetArrayElementAtIndex (10), true, true, 2);

			labelWithProperty ("Xbox Dpad Down", 140, selectedVars.GetArrayElementAtIndex (11), true, true, 2);

			labelWithProperty ("Xbox Dpad Left", 140, selectedVars.GetArrayElementAtIndex (12), true, true, 2);
				
			labelWithProperty ("Xbox Dpad Right", 140, selectedVars.GetArrayElementAtIndex (13), true, true, 2);
		} else {
		...
		if (state.FindPropertyRelative ("displayVariable").boolValue) {
			...
			labelWithProperty ("Xbox Left Stick Axis", 140, selectedVars.GetArrayElementAtIndex (14), true, true, 2);

			labelWithProperty ("Xbox Right Stick Axis", 140, selectedVars.GetArrayElementAtIndex (15), true, true, 2);

			labelWithProperty ("Xbox Trigger Left", 140, selectedVars.GetArrayElementAtIndex (16), true, true, 2);

			labelWithProperty ("Xbox Trigger Right", 140, selectedVars.GetArrayElementAtIndex (17), true, true, 2);
